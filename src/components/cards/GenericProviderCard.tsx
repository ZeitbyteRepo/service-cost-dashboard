...
export default function GenericProviderCard({ provider, interactionMode = 'link', onSelect, selected = false }: Props) {
    ...
    <article className={shellClass}>
      ...
      <div className="space-y-1.5">
        <div className="grid grid-cols-[auto_1fr] items-center gap-x-2 gap-y-0.5">
          <p className="card-metric-label text-[10px] uppercase tracking-[0.12em] text-blue-200">Month Cost</p>
        ...
        <div className="grid grid-cols-[auto_1fr] items-center gap-x-2 gap-y-0.5">
          <p className="card-metric-label text-[10px] uppercase tracking-[0.12em] text-blue-200">Usage</p>
          <p className="truncate text-right text-xs font-semibold text-orange-300">
